...
# Example: https://github.com/graphite-project/graphite-web/blob/master/webapp/graphite/local_settings.py.example
#####################################
...
# Visit: http://www.miniwebtool.com/django-secret-key-generator/
SECRET_KEY = '2=_qu3wq6=1bn)dafe=-^9276fh1uf=4+y_uomh73eh!bf(w86'
...
# to somewhere else
GRAPHITE_ROOT = '{{ install_prefix }}'

# Most installs done outside of a separate tree such as /opt/graphite will only
# need to change these three settings. Note that the default settings for each
# of these is relative to GRAPHITE_ROOT
CONF_DIR = '{{ install_prefix }}/conf'
STORAGE_DIR = '{{ install_prefix }}/storage'
STATIC_ROOT = '{{ install_prefix }}/static'
CONTENT_DIR = '{{ install_prefix }}/webapp/content'
CSS_DIR = '{{ install_prefix }}/webapp/content/css'
# To further or fully customize the paths, modify the following. Note that the
# default settings for each of these are relative to CONF_DIR and STORAGE_DIR
#
## Webapp config files
DASHBOARD_CONF = '{{ install_prefix }}/conf/dashboard.conf'
GRAPHTEMPLATES_CONF = '{{ install_prefix }}/conf/graphTemplates.conf'

## Data directories
# NOTE: If any directory is unreadable in STANDARD_DIRS it will break metric browsing
# CERES_DIR = '/opt/graphite/storage/ceres'
WHISPER_DIR = '{{ install_prefix }}/storage/whisper'
RRD_DIR = '{{ graphite_rrd }}'
...
LOG_DIR = '{{ install_prefix }}/log/webapp'
...
DATABASES = {
    'default': {
        'NAME': '{{ install_prefix }}/storage/whisper/graphite.db',
